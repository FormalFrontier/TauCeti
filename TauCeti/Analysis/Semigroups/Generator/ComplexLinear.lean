...
* K.-J. Engel and R. Nagel, *One-Parameter Semigroups for Linear Evolution Equations*,
  Section II.2.1 (similar semigroups), Theorem II.1.4 (the generator determines the semigroup)
  and Section II.3.11 (unitary groups and their generators).
...
* M. Reed and B. Simon, *Methods of Modern Mathematical Physics I: Functional Analysis*,
  Theorem VIII.8.
* Roadmap: `TauCetiRoadmap/OneParameterSemigroups/README.md`, Part A.
-/
