...
* `TauCeti.W1p0.value_extendByZeroL_eq_zero_ae_compl`: the whole-space extension vanishes almost
  everywhere off `Ω`.
...
theorem W1p0.value_extendByZeroL_eq_zero_ae_compl (u : W1p0 mu Omega p) :
