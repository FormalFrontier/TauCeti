...
one or two of its points (`TauCeti.Topology.JordanCurve.Separation`), the fact that two nearby
points cut off an arc of small diameter (`TauCeti.Topology.JordanCurve.SmallArc`), and the
classification of the compact connected subsets of a curve
