...
* `TauCeti.representation_glCasimir_apply`: its action on any Lie module is the double-action
  sum `∑ i, ∑ j, ⁅Eᵢⱼ, ⁅Eⱼᵢ, m⁆⁆`.
* `TauCeti.glCasimir_smul_of_isGlHighestWeightVector`: its scalar action on a cyclic
...
private theorem lie_single_lie_single_of_isGlHighestWeightVector
  ...
  · rw [leibniz_lie, lie_single_single_eq_sub, sub_lie,
      hv.lie_single_self_eq_smul, hv.lie_single_self_eq_smul,
