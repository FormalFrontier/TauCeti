...
* `TauCeti.glCasimir_eq_sum`: its defining matrix-unit sum.
...
private theorem ι_single_mul_glCasimir (a b : n) :
  ...
  rw [← sub_eq_zero, glCasimir_eq_sum, Finset.mul_sum, Finset.sum_mul,
...
theorem representation_glCasimir_apply (m : M) :
  ...
  rw [glCasimir_eq_sum, map_sum, LinearMap.sum_apply]
  apply Finset.sum_congr rfl
  intro i _
