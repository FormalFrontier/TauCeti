...
* `TauCeti.mem_of_trace_eq_zero_of_single_mem`: a submodule of `gl n R` containing the off-diagonal
...
(`TauCeti.derivedSeries_one_eq_slIdeal`), and a Lie ideal containing a non-central element contains
