...
* `TauCeti.IsSl2Triple.eq_two_of_lie_h_e_eq_smul`: the raising eigenvalue of an `sl₂` triple is
...
theorem eq_two_of_lie_h_e_eq_smul {S H : Type*} [CommRing S] [LieRing H] [LieAlgebra S H]
    [NoZeroSMulDivisors S H] {h e f : H} (t : _root_.IsSl2Triple h e f) {a : S}
    (ha : ⁅h, e⁆ = a • e) : a = 2 := by
