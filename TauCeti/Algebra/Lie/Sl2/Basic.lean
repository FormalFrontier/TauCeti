...
The second packages the primitive-vector calculus into a reusable finite-string criterion. A
nonzero integral-weight vector killed by the lowering element becomes primitive for the symmetric
triple, and the corresponding number of raising operations kills it. This is the generic core of
higher Serre relations.

The third is the presentation of `sl₂` by its relations, for an arbitrary Lie algebra: a triple is
...
The fourth is perfectness of a Lie algebra generated by a triple, in the form the module theory
