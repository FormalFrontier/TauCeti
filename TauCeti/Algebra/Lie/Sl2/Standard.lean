...
* `TauCeti.Sl2Std.isNilpotent_raise` and `TauCeti.Sl2Std.isNilpotent_lower`: nilpotence of the
  raising and lowering operators on `V(n)`, with `TauCeti.Sl2Std.raise_pow_eq_zero` and
  `TauCeti.Sl2Std.lower_pow_eq_zero` giving the explicit exponent `n + 1`.
