...
theorem hasInvariantOutsideIrreducible_of_toLieSubalgebra_eq_top
  ...
  rw [hasInvariantOutsideIrreducible_iff]
...
theorem exists_invariant_notMem (htop : t.toLieSubalgebra K = ⊤) [FiniteDimensional K M]
    ...
    ∃ v : M, v ∉ N ∧ ∀ x : L, ⁅x, v⁆ = 0 :=
  (hasInvariantOutsideIrreducible_of_toLieSubalgebra_eq_top htop).exists_invariant_notMem N hN htriv
...
theorem exists_isCompl_of_toLieSubalgebra_eq_top (htop : t.toLieSubalgebra K = ⊤)
  ...
  (hasInvariantOutsideIrreducible_of_toLieSubalgebra_eq_top htop).exists_isCompl N
