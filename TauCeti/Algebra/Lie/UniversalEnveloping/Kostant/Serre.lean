...
the Serre generators and relations. This file equips its enveloping algebra with the canonical
integral form generated by the divided powers of the raising and lowering generators and by the
...
This is the usual generator description of the Kostant form. It applies to an arbitrary integer
matrix because the construction and its elementary symmetries only use the presentation. When
`CM` is the Cartan matrix of a root datum, this is the explicit integral enveloping algebra used
in the Chevalley--Demazure construction.
...
/-- The **Kostant integral form of the Serre presentation**: the subring generated by every
divided power of a simple raising or lowering generator and every binomial coefficient in a
Cartan generator. -/
...
noncomputable def serreDiagramKostantEquiv :
  ...
  (RingEquiv.subringCongr (serreKostantForm_def CM)).trans
    ((kostantFormEquiv (serreDiagramAut ℚ CM hσ) (serreRootGenerator CM) (serreH ℚ CM)).trans
      (RingEquiv.subringCongr (kostantForm_serreDiagramAut_eq CM hσ)))
...
theorem coe_serreDiagramKostantEquiv_apply (x : serreKostantForm CM) :
    (serreDiagramKostantEquiv CM hσ x : U) =
      map ℚ (serreDiagramAut ℚ CM hσ).toLieHom x := by
  rw [serreDiagramKostantEquiv, RingEquiv.trans_apply, RingEquiv.trans_apply]
...
noncomputable def serreChevalleyKostantEquiv :
    serreKostantForm CM ≃+* serreKostantForm CM :=
  (RingEquiv.subringCongr (serreKostantForm_def CM)).trans
    ((kostantFormEquiv (serreChevalleyInvolution ℚ CM) (serreRootGenerator CM)
        (serreH ℚ CM)).trans
      (RingEquiv.subringCongr (kostantForm_serreChevalleyInvolution_eq CM)))
...
theorem coe_serreChevalleyKostantEquiv_apply (x : serreKostantForm CM) :
    (serreChevalleyKostantEquiv CM x : U) =
      map ℚ (serreChevalleyInvolution ℚ CM).toLieHom x := by
  rw [serreChevalleyKostantEquiv, RingEquiv.trans_apply, RingEquiv.trans_apply]
  simpa only [RingEquiv.coe_subringCongr_apply] using
