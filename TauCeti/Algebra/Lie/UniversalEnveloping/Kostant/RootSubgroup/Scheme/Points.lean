...
@[expose] noncomputable def kostantGeneratedPointsSubgroup (A : Type v) [CommRing A] :
...
theorem map_mem_kostantGeneratedPointsSubgroup {A : Type v} {B : Type v'}
  ...
  exact GeneralLinear.map_mem_hopfIdealPointsSubgroup n
    (kostantGeneratedDefiningIdeal e h ρ M hM hnil b) φ.toIntAlgHom hg
...
noncomputable def mapKostantGeneratedPointsSubgroup {A : Type v} {B : Type v'}
  ...
  GeneralLinear.mapHopfIdealPointsSubgroup n
    (kostantGeneratedDefiningIdeal e h ρ M hM hnil b) φ.toIntAlgHom
...
theorem coe_mapKostantGeneratedPointsSubgroup {A : Type v} {B : Type v'}
  ...
  exact GeneralLinear.coe_mapHopfIdealPointsSubgroup n
    (kostantGeneratedDefiningIdeal e h ρ M hM hnil b) φ.toIntAlgHom g
