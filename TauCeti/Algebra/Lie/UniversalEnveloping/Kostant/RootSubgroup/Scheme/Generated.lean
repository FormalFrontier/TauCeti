...
noncomputable abbrev kostantGeneratedDefiningIdeal :
...
instance isClosedImmersion_kostantGeneratedGroupSchemeι :
  ...
  rw [kostantGeneratedGroupSchemeι, CommHopfAlgCat.quotientSpecι_def]
...
noncomputable abbrev kostantRootSubgroupGeneratedCoordinateMap (i : I) :
...
theorem kostantRootSubgroupToGenerated_comp_ι (i : I) :
  ...
  rw [kostantRootSubgroupToGenerated, kostantGeneratedGroupSchemeι,
    CommHopfAlgCat.quotientSpecι_def, kostantRootSubgroup_def]
  slice_lhs 2 3 =>
    rw [← (AlgebraicGeometry.hopfSpec (CommRingCat.of ℤ)).map_comp,
      ← op_comp, CommHopfAlgCat.mkQuotient_comp_commonKernelLift]
