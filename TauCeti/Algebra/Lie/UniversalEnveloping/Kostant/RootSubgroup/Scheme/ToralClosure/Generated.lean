...
`TauCeti.Algebra.Lie.UniversalEnveloping.Kostant.RootSubgroup.Scheme.ToralClosure.Basic`. This file
relates that full toral carrier to the group scheme generated by the root subgroups alone.
