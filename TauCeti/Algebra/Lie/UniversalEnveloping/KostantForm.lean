...
coefficients in that vector. Consequently `TauCeti.ringChooseSubring` for any designated Cartan
...
* `TauCeti.UniversalEnvelopingAlgebra.ringChooseSubring_le_kostantForm`: the one-Cartan integral
  binomial subring lies in the Kostant form.
