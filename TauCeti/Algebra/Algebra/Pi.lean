...
The injectivity half is what Mathlib does not record, and it is what makes the equivalence useful
for counting: a split commutative algebra has exactly as many characters as it has factors. The
Burnside--Dixon--Schneider algorithm consumes it in that form, to count the central characters of a
group algebra whose centre has been split into coordinates.
...
variable (R ι : Type*) [CommSemiring R] [NoZeroDivisors R] [Nontrivial R] [Finite ι]
