...
/-- The tensor square of a bialgebra morphism carries the left tensor ideal generated by `I`
onto the left tensor ideal generated by the image of `I`. -/
theorem map_tensor_leftTensorIdeal (f : H →ₐc[R] K) (I : Ideal H) :
...
/-- The tensor square of a bialgebra morphism carries the right tensor ideal generated by `I`
...
theorem map_tensor_rightTensorIdeal (f : H →ₐc[R] K) (I : Ideal H) :
    Ideal.map (Algebra.TensorProduct.map (f : H →ₐ[R] K) (f : H →ₐ[R] K)).toRingHom
