...
/-- A move-or-inverse step is a stellar move in one of the two directions. -/
@[simp]
theorem isStellarMoveOrInverse_iff :
    IsStellarMoveOrInverse K L ↔ IsStellarMove K L ∨ IsStellarMove L K :=
  Iff.rfl
