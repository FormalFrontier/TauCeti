...
theorem hasDerivAt_Ad_mulInvariantExp_smul_apply_zero
  ...
  let eIso := leftInvariantDerivationLinearIsometryEquivModelVectorSpace
    (I := I) (G := G)
  have htangent := hasDerivAt_tangentAd_mulInvariantExp_smul_apply_zero
...
theorem mvfderiv_Ad_apply (X Y : LeftInvariantDerivation I G) :
  ...
  have hpath := hasDerivAt_Ad_mulInvariantExp_smul_apply_zero (I := I) (G := G) X Y
