...
theorem HasMFDerivAt.hasDerivAt_comp_mulInvariantExp_smul {f : G → F}
...
theorem HasMFDerivAt.hasDerivAt_comp_mul_mulInvariantExp_smul {f : G → F} {g : G}
...
theorem HasMFDerivAt.hasDerivAt_comp_mulInvariantExp_smul_mul {f : G → F} {g : G}
    {f' : TangentSpace I g →L[ℝ] F} (hf : HasMFDerivAt I 𝓘(ℝ, F) f g f')
