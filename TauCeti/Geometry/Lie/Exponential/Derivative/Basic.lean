...
calculation supplies reusable chain rules for scalar functions along translated exponential lines.
...
* `hasMFDerivAt_mulInvariantExp_smul`: an exponential line has its generator as initial velocity.
* `HasMFDerivAt.hasDerivAt_comp_mulInvariantExp_smul`: the chain rule along an exponential line.
* `HasMFDerivAt.hasDerivAt_comp_mul_mulInvariantExp_smul`: the chain rule after left translation.
* `HasMFDerivAt.hasDerivAt_comp_mulInvariantExp_smul_mul`: the chain rule after right translation.

## References

* [Lie groups and the Lie algebra correspondence roadmap](https://github.com/TauCetiProject/TauCetiRoadmap/blob/main/TauCetiRoadmap/RepresentationTheory/LieGroups/README.md),
  Deliverable A, Layer 0, "The exponential map", and Layer 1, "The infinitesimal adjoint".
-/
...
variable [CompleteSpace E] [LieGroup I ∞ G]
...
/-- Differentiating a scalar function after left multiplication along an exponential line gives
