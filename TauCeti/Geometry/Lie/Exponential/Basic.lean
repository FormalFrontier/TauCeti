...
* `oneParameterSubgroup_eq_mulInvariantOneParameterSubgroup`: the derivation-based subgroup is
  the tangent-space subgroup transported through evaluation at the identity.
...
transporting its generator through evaluation at the identity. -/
