...
* `contMDiff_mulInvariantIntegralCurve`: canonical invariant curves are smooth.
...
section SmoothInvariantCurve

variable [CompleteSpace E] [LieGroup I ∞ G] [T2Space G] [BoundarylessManifold I G]

local instance lieGroupMinSmoothnessSmoothCurve : LieGroup I (minSmoothness ℝ 3) G := by
