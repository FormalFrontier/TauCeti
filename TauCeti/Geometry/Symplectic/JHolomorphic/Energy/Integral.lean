...
@[expose] noncomputable def stdComplexLineEnergy
...
-- elimination API of the energy, written out by hand rather than generated by `irreducible_def`:
-- the generated equation lemma states the elaborated body, which mentions a proof constant the
-- module system keeps private.
