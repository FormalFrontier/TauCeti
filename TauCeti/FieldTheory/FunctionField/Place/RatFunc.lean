...
* `TauCeti.Place.degree_adic_eq_natDegree`,
  `TauCeti.Place.exists_monic_irreducible_degree_adic_eq_natDegree` and
...
(Stichtenoth, Proposition 1.2.1(a)). Only the existence of such a polynomial is recorded here;
that it generates the prime of the place, and is the unique monic irreducible polynomial doing
so, is `IsDedekindDomain.HeightOneSpectrum.existsUnique_monic_irreducible_span`. -/
