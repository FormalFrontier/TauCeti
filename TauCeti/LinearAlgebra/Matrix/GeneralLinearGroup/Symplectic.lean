...
its points with this subgroup are the algebraic-group half of the worked example; they follow
separately, alongside `TauCeti/Algebra/AlgebraicGroup/GeneralLinear/Borel.lean`.
