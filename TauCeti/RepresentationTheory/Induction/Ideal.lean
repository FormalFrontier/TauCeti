...
* `TauCeti.ClassFunction.indVirtualCharacters_eq_closure_indCharacter`: induced genuine characters
  already generate the subgroup of induced virtual characters.
...
* `TauCeti.ClassFunction.indVirtualCharacterDirectSumBaseChangeRat_surjective`: a general
  criterion for rational surjectivity of the scalar-extended induction map.
...
-/
theorem indVirtualCharacters_eq_closure_indCharacter :
