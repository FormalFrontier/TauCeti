...
* [Character theory roadmap](https://github.com/TauCetiProject/TauCetiRoadmap/blob/main/TauCetiRoadmap/RepresentationTheory/CharacterTheory/README.md),
  ...
  the invariant forms with the invariants of the two squares of the dual representation. What this
  file supplies is the counting identity those statements are read off from.
