...
public import TauCeti.RingTheory.RootsOfUnity.IsIntegral
...
and integrality of a root of unity in `TauCeti.RingTheory.RootsOfUnity.IsIntegral`.
...
theorem exists_multiset_character_eq_sum [IsAlgClosed k] (ρ : Representation k G V) {g : G} {n : ℕ}
  ...
  rw [IsAlgClosed.card_roots_eq_natDegree, LinearMap.charpoly_natDegree]
