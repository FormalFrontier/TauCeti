...
commit `ccc3323c6750abca25b49b35106f54eb3a398509`. The degree-`-2` identification combines
Mathlib's comparison with group homology, `groupHomology.H1AddEquivOfIsTrivial`, and the
tensor-product right unitor.
