...
the subalgebra generated by the two coordinates (`algebraMap_mem_adjoin_genericPoint`).
...
* `WeierstrassCurve.Affine.algebraMap_mem_adjoin_genericPoint`: the coordinate ring, read inside the
  function field, lies in the `R`-subalgebra generated by the generic point.
