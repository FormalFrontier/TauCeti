...
and his Corollary 6.4 — that `A°` is the union of the rings of definition, that the subring
generated by two rings of definition is again one, and that their intersection is one too. On the
**ideal** side, a companion of the union description: `A°°` is the union of the *ideals* of
definition, and is therefore open.
...
/-! ### The remaining parts of Wedhorn Corollary 6.4 -/
