    ...
    { ringOfDefinition := Subring.closure ((P.ringOfDefinition : Set A) ∪ (T : Set A))
      ...
      isAdic_idealOfDefinition := by
        ...
        · intro s hs
          ...
          obtain ⟨V, hV, hVB⟩ := isBounded_iff.mp
            (isBounded_subringClosure_union_finset P.ringOfDefinition
              P.isBounded_ringOfDefinition T hT) (G : Set A) (G.isOpen.mem_nhds G.zero_mem)
