...
def main() -> None:
    ...
    # Cache lookup walks all fetched ancestry -- this step reads the published comparison
    # base, so a bound could only turn a first-lookup hit into a full recompile -- and
    # executable profiling helpers come from the workflow-pinned trusted checkout, not the PR.
